          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="shop-cat-box">
              <img
                ...
                alt=""
              />
              <a class="btn hvr-hover" href="#">Đắc nhân tâm</a>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="shop-cat-box">
              <img
                class="img-fluid"
                src="https://sachtiengviet.com/cdn/shop/files/8d27614559ab25d234f3964359a20613.jpg?v=1713049346"
                alt=""
              />
              <a class="btn hvr-hover" href="#">Thao túng tâm lý</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="title-all text-center">
              <h1>Sách nổi bật</h1>
              <p>
                Nội dung cuốn hút, dễ đọc, được nhiều độc giả yêu thích.
            </div>
          </div>
        </div>
        <div class="row">
